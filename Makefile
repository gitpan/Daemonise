# This Makefile is for the Daemonise extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Daemonise.pm]
#     AUTHOR => q[Andy D <andydixon@apple.com>]
#     NAME => q[Daemonise]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Daemonise.pm]
...
TO_INST_PM = lib/Daemonise.pm

PM_TO_BLIB = lib/Daemonise.pm \
	blib/lib/Daemonise.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Daemonise.pm $(INST_MAN3DIR)/Daemonise.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Daemonise' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      1.0' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Daemonise.pm' >> META_new.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Perl extension for convenience to daemonise a script</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Andy D &lt;andydixon@apple.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Daemonise.pm blib/lib/Daemonise.pm 
